...
public class SocketCliente {
     ...
     public static void main (String [] args) {
         ...
         try {
             ...
             System.out.println("Esto es " + jsonInString);//aquí se ve impreso, es lo que eventualmente se envia por medio del DatoSocket
     ...
     public SocketCliente()
     {
         try
         {
             ...
             Socket socket = new Socket ("192.168.1.27", 15557);
             ...
             * el otro lado */
             ...
             /* Se lee un Datosocket que nos envia el servidor y se muestra
              * en pantalla */
            ...
            // DataOutputStream bufferSalida = new DataOutputStream (socket.getOutputStream());
             ...
             /* La llamada a setSoLinger() hara que el cierre espere a que el otro lado retire los datos que hemos enviado */
             socket.close();
         }
         catch (Exception e) {
             e.printStackTrace();
